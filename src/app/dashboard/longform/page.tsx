...
export default function LongformPage() {
  return (
    <Suspense fallback={<div className="p-8 h-full flex justify-center items-center text-muted-foreground"><Loader2 className="w-6 h-6 animate-spin mr-2"/> Loading AI search...</div>}>
      <LongformDashboardContent />
    </Suspense>
  );
}
